...
public class SendReceiveMessages
{
    ...
    public static void main(String[] args)
    {
       SqsClient sqs = SqsClient.builder().region(Region.US_EAST_1).build();
        ...
        List<Message> messages2 = sqs.receiveMessage(receiveRequest).messages();
        List<Message> messages3 = sqs.receiveMessage(receiveRequest).messages();
        List<Message> messages4 = sqs.receiveMessage(receiveRequest).messages();
